        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Generating"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizQuestions", x => new { x.QuizId, x.QuizQuestionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizAnswers", x => new { x.QuizId, x.QuizQuestionId, x.QuizAnswerId });
                    table.ForeignKey(
                        name: "FK_QuizAnswers_QuizQuestions_QuizId_QuizQuestionId",
                        columns: x => new { x.QuizId, x.QuizQuestionId },
                        principalTable: "QuizQuestions",
                        principalColumns: new[] { "QuizId", "QuizQuestionId" },
                        onDelete: ReferentialAction.Cascade);
                });
